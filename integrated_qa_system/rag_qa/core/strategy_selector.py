...
if __name__ == '__main__':
    ss = StrategySelector()
    print(ss.select_strategy('神经网络是什么?'))
    print(ss.select_strategy('Agent的应用领域有哪些?'))
    print(ss.select_strategy('比较 MySQL 和 MongoDB 的优缺点。'))
    print(ss.select_strategy('向Mysql插入100w条数据，可以吗？'))
